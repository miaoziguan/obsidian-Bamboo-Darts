...
export const CN_WORD_DICT = new Set([
  // 抽象概念
  '系统', '结构', '机制', '模型', '模式', '策略', '方案', '框架',
  '算法', '方法', '理论', '原理', '规律', '趋势', '周期', '阶段',
  '效率', '性能', '质量', '成本', '收益', '风险', '价值', '优势',
  '劣势', '核心', '关键', '本质', '基础', '前提', '条件', '因素',
  '目标', '标准', '指标', '变量', '参数', '维度', '层次', '边界',
  '创新', '变革', '转型', '升级', '迭代', '演化', '进化', '突破',
  '颠覆', '重构', '重塑', '整合', '协同', '耦合', '解耦', '对齐',
  // 技术领域
  '数据', '信息', '知识', '信号', '网络', '接口', '协议', '缓存',
  '索引', '查询', '存储', '计算', '调度', '分配', '回收', '压缩',
  '编码', '解码', '加密', '签名', '认证', '授权', '路由', '代理',
  '容器', '进程', '线程', '协程', '管道', '队列', '堆栈', '内存',
  '指令', '流水', '分支', '循环', '递归', '回调', '事件', '状态',
  '输入', '输出', '渲染', '布局', '样式', '组件', '模块', '依赖',
  // AI 领域
  '模型', '参数', '权重', '梯度', '损失', '优化', '收敛', '泛化',
  '过拟合', '欠拟合', '正则', '归一', '激活', '嵌入', '编码器',
  '解码器', '注意力', '残差', '归一化', '分词', '采样', '推理',
  '训练', '预测', '分类', '回归', '聚类', '降维', '生成', '判别',
  // 商业/经济
  '市场', '竞争', '垄断', '壁垒', '定价', '营销', '品牌', '渠道',
  '用户', '客户', '需求', '供给', '增长', '利润', '营收', '规模',
  '效应', '杠杆', '边际', '弹性', '均衡', '激励', '约束', '博弈',
  '融资', '估值', '上市', '并购', '重组', '期权', '股权', '分红',
  // 认知/方法论
  '认知', '思维', '视角', '框架', '原则', '逻辑', '推理', '判断',
  '决策', '选择', '权衡', '取舍', '优先级', '注意力', '习惯',
  '反馈', '复盘', '迭代', '试错', '验证', '假设', '实验', '数据',
  '抽象', '简化', '分解', '组合', '类比', '迁移', '复用', '杠杆',
  // 高频动词/形容词（有独立语义的）
  '提升', '降低', '优化', '简化', '增强', '削弱', '加速', '延缓',
  '扩大', '缩小', '集中', '分散', '统一', '分离', '开放', '封闭',
